...
public class LocateOnMapActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabCurrent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                text.setText(getString(R.string.location_1) + ApiConfig.getAddress(latitude, longitude, LocateOnMapActivity.this));
            }
        });
    ...
    private void getCurrentLocation() {
        ...
        if (ContextCompat.checkSelfPermission(LocateOnMapActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton(getString(R.string.ok), new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ActivityCompat.requestPermissions(LocateOnMapActivity.this,
...
//                    }
    ...
    private void moveMap(boolean isfirst) {
        ...
        address = ApiConfig.getAddress(latitude, longitude, LocateOnMapActivity.this);
